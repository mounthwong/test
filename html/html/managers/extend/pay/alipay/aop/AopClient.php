...
class AopClient {
	//应用ID
	public $appId=AliPayConfig::APPID;
	
	//私钥文件路径
	public $rsaPrivateKeyFilePath;

	//私钥值
	public $rsaPrivateKey=AliPayConfig::RSAPRIVATEKEY;

	//网关
	//public $gatewayUrl = "https://openapi.alipay.com/gateway.do";
	public $gatewayUrl = AliPayConfig::GETWAYURL;
	//返回数据格式
	public $format = "JSON";
	//api版本
	...
	//使用读取字符串格式，请只传递该值
	public $alipayrsaPublicKey=AliPayConfig::ALIPAYRSAPUBLICKEY;
