...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <?php echo datetime($row['jointime']); ?>
        </div>
    </div>
    <div class="form-group">
