...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <select class="form-control" name="row[type]">
                <option value="0" selected="selected">资讯信息</option>
                <option value="1">自救信息</option>
            </select>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[cataglory]', $infocataglory, 0, ['class'=>'form-control','data-rule'=>'required']); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="c-username" class="control-label col-xs-12 col-sm-2"><?php echo __('Title'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-username" data-rule="required" class="form-control" name="row[title]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="remark" class="control-label col-xs-12 col-sm-2"><?php echo __('Desp'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea class="form-control" id="remark" name="row[desp]"></textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-avatar" data-rule="" class="form-control" size="50" name="row[pic]" type="text" value="">
    ...
    <div class="tab-pane" id="tab2">
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <textarea class="editor" id="remark" name="row[content]"></textarea>
            </div>
        </div>
    </div>
