                ...
                <div id="content">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <?php endif; ?>
                            <div class="content">
                                <form enctype="multipart/form-data" method="POST" action="../../../api/common/upload">
