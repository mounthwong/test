...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-password" data-rule="" class="form-control" name="row[password]" type="text" value="" placeholder="" autocomplete="new-password" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="c-mobile" class="control-label col-xs-12 col-sm-2"><?php echo __('IDcard'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-mobile" data-rule="" class="form-control" name="row[idcard]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[gender]', ['1'=>__('Male'), '0'=>__('Female')], '1'); ?>
        </div>
    </div>
    <div class="form-group">
